 ...
 * @author ROG
 */
public class AdminUpdateResultForm extends javax.swing.JFrame {

    /** Creates new form AdminUpdateResultForm */
    public AdminUpdateResultForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(updateResult, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(169, 169, 169))
        );
    ...
    private void updateResultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateResultActionPerformed
        ...
        try{
            ...
            ResultSet rs=stmt.executeQuery("select * from result where rollno='"+rollNo+"'");
            if(rs.next()){
                this.setVisible(false);
                new UpdateResult(rs).setVisible(true);
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminUpdateResultForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
